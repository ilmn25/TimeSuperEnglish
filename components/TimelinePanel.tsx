                            ...
                            {bookings.map((booking) => {
                                ...
                                return (
                                    <div key={booking.id} className="absolute left-0 right-0 group" style={{ top: `${top}%`, height: `${height}%` }} title={tooltip}>
                                        ...
                                        {booking.check_in && height > 0 && ( /* Added height > 0 check to prevent division by zero for zero-duration bookings */
                                            <div
                                                ...
                                                style={{
                                                    top: `${((attTop - top) / height) * 100}%`, /* Corrected calculation for relative top */
                                                    height: `${(attHeight / height) * 100}%`, /* Corrected calculation for relative height */
                                                    backgroundColor: hexToRgba(courseColor, 0.8),
                                                    borderLeftColor: courseColor,
                                                    borderTopColor: hexToRgba(courseColor, 0.2), /* Fixed variable name */
                                                    borderRightColor: hexToRgba(courseColor, 0.2), /* Fixed variable name */
                                                    borderBottomColor: hexToRgba(courseColor, 0.2) /* Fixed variable name */
                                                }}
                                            >
