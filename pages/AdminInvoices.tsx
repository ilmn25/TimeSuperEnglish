            ...
            <table className="w-full text-left min-w-[1000px]">
              ...
              <tbody className="divide-y divide-slate-100">
                {processedInvoices.map(inv => (
                  <tr key={inv.id} className="hover:bg-slate-50 transition-colors cursor-pointer" onClick={() => navigate(`/portal/admin/org/${orgId}/invoices/${inv.id}`)}>
                    ...
                    <td className="px-6 py-5 text-right">
                       <button 
                         onClick={(e) => { e.stopPropagation(); navigate(`/portal/admin/org/${orgId}/invoices/${inv.id}`); }}
