...
const resources = {
  en: {
    translation: {
      ...
      nav: { home: "Home", attendance: "Attendance", bookings: "Bookings", courses: "Courses", students: "Students", backup: "Backup", organizations: "Organizations", back: "Back", import: "Import", export: "Export", subscriptions: "Billing", issues: "Issues" },
  ...
  "zh-CN": {
    translation: {
      ...
      nav: { home: "首页", attendance: "考勤", bookings: "预约", courses: "课程", students: "学生", backup: "备份", organizations: "机构", back: "返回", import: "导入", export: "导出", subscriptions: "订阅", issues: "异常处理" },
  ...
  "zh-TW": {
    translation: {
      app: { name: "計數器", dashboard: "計數器門戶" },
      nav: { home: "首頁", attendance: "考勤", bookings: "預約", courses: "課程", students: "學生", backup: "備份", organizations: "機構", back: "返回", import: "匯入", export: "匯出", subscriptions: "訂閱", issues: "異常處理" },
      user: { signed_in: "登入身分", logout: "登出" },
      auth: { signin: "登入", register: "註冊", email: "電子郵件", password: "密碼", create_account: "建立帳戶", continue: "或繼續使用", google: "Google 帳戶", access: "門戶存取", check_email: "請檢查您的電子郵件以取得確認連結！" },
      ...
      students: { title: "學生名錄", subtitle: "管理學生檔案和門戶存取", register: "註冊學生", search: "按姓名、年級或聯絡方式搜尋...", sort_name: "姓名", sort_level: "年級", no_contact: "無聯絡資訊", access: "存取權限", no_match: "未找到相符的學生", adjust_query: "嘗試調整搜尋詞或註冊新學生。", clear_filters: "清除篩選", edit_profile: "編輯檔案", registration: "註冊", student_data: "學生資料", full_name: "全名", grade_level: "年級", select: "選擇", contact: "聯絡方式", register_now: "立即註冊", dashboard_access: "門戶存取", manage_links: "管理連結對象", authorized_parents: "授權家長帳戶", no_accounts: "暫無關聯帳戶", invite: "邀請家長存取門戶", link: "連結", unlink_title: "取消連結家長？", unlink_msg: "移除門戶存取權限對象", unlink: "取消連結", delete_title: "刪除檔案？", delete_msg: "永久刪除此學生？這將清除所有考勤歷史和關聯的家長帳戶。" },
      ...
      parent: { dashboard: "門戶", subtitle: "學生活動和狀態", go_today: "回到今天", edit_profile: "編輯學生檔案", updating: "正在更新檔案對象", unset: "未設定", in_class: "上課中", away: "不在校", no_bookings: "預約", no_activity: "無活動", session: "工作階段", live: "即時", now: "現在" },
